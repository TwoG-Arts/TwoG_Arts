...
function language() {
    ...
    if (check.checked) {
        ...
        if (wrap) {
            ...
            toTranslate[it.next().value].innerHTML = '<img id="logoAboutMe" src="images/LogoAboutMe.png">I am 2G_Arts, a software developer, graphic designer, photographer, VFX artist, and web designer with a degree in New Technologies of Art. I integrate technical and creative skills to develop digital solutions, innovative graphic projects, and high-quality visual productions. My work stands out for its attention to detail and a multidisciplinary approach that transforms ideas into tangible results. On this website, you can explore a showcase of my work.';
        ...
        if (wrap) {
            ...
            toTranslate[it.next().value].innerHTML = '<img id="logoAboutMe" src="images/LogoAboutMe.png">Sono 2G_Arts, sviluppatore software, grafico, fotografo, VFX artist e webdesigner laureato in Nuove Tecnologie dell\'Arte. Integro competenze tecniche e creative per realizzare soluzioni digitali, progetti grafici innovativi e produzioni visive di alto livello. Il mio lavoro si distingue per l’attenzione ai dettagli e un approccio multidisciplinare che trasforma idee in risultati concreti. In questo sito potrete consultare una vetrina dei miei lavori.';
