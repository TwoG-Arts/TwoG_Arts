...
function language() {
    ...
    if (check.checked) {
        ...
        if (wrap) {
            ...
            toTranslate[it.next().value].innerHTML = '<img id="logoAboutMe" src="images/LogoAboutMe.png">Hello everyone, I\'m 2G_Arts! I\'m a computer technician by profession, but my true passion lies in art, particularly in the world of anime and manga. My artistic creations are strongly influenced by the stories that have struck me the most. I particularly love works like Steins; Gate, an anime that has deeply inspired me, and Attack on Titan, which has taught me that in artistic creation, technique is important, but it\'s the concept behind a work that truly makes it special. I also have great admiration for directors like Christopher Nolan and Martin Scorsese, and I always try to incorporate a touch of their style into my work. Currently, I hold a degree in New Technologies of Art and am primarily active as a photographer. For me, art is a way of expressing my emotions and thoughts in a unique and creative way. I enjoy bending reality without losing touch with it, creating works that reflect who I am and what I feel. I hope that my creations will move you as much as they move me in creating them!';
            toTranslate[it.next().value].innerHTML = '<div class="overlay-left"><img src="images/ovhone.png"></div>Photos<div class="overlay-right"><img src="images/ovhone.png"></div>';        
            ...
            toTranslate[it.next().value].innerHTML = '<div class="overlay-left"><img src="images/ovhone.png"></div>Collaborations<div class="overlay-right"><img src="images/ovhone.png"></div>';
            toTranslate[it.next().value].innerHTML = '<div class="overlay-left"><img src="images/ovhone.png"></div>Special Thanks<div class="overlay-right"><img src="images/ovhone.png"></div>';
            toTranslate[it.next().value].innerHTML = '<a href="https://github.com/Rankoll" target="_blank">Rankoll</a> for co-programming the site.';
            toTranslate[it.next().value].innerHTML = 'lexA & Xion Romeruf for the supervision of texts.';
            toTranslate[it.next().value].innerHTML = '<a href="https://www.instagram.com/michelelosciale/" target="_blank">Losmichele</a> & <a href="https://www.instagram.com/deadman_cosplay/" target="_blank">RaamDeadman</a> for the agreement of sharing the collaborations.';
            toTranslate[it.next().value].innerHTML = '<a href="https://github.com" target="_blank">GitHub</a> for the hosting.';
            toTranslate[it.next().value].innerHTML = 'A special thanks to <a href="https://www.platinumgames.com/" target="_blank">Platinum Games</a> and <a href="https://twitter.com/yokotaro" target="_blank">Yoko Taro</a>.';
        ...
        if (wrap) {
            ...
            toTranslate[it.next().value].innerHTML = '<img id="logoAboutMe" src="images/LogoAboutMe.png">Ciao a tutti, sono 2G_Arts! Sono un tecnico informatico di professione, ma la mia vera passione risiede nell\'arte, in particolare nell\'universo degli anime e dei manga. Le mie creazioni artistiche sono fortemente influenzate dalle storie che più mi hanno colpito. Amo particolarmente opere come Steins; Gate, un anime che mi ha ispirato profondamente, e L\'Attacco dei giganti, che mi ha insegnato che nella creazione artistica, la tecnica è importante, ma è il concetto dietro un\'opera a renderla davvero speciale. Ho anche una grande ammirazione per registi come Christopher Nolan e Martin Scorsese, e cerco sempre di incorporare un tocco del loro stile nei miei lavori. Attualmente, sono laureato in Nuove Tecnologie dell\'Arte e attivo principalmente come fotografo. Per me, l\'arte è un modo di esprimere le mie emozioni e pensieri in modo unico e creativo. Mi piace piegare la realtà senza perderne il contatto, creando opere che riflettono chi sono e cosa sento. Spero che le mie creazioni vi emozionino tanto quanto me emozionano nel crearle!';
            toTranslate[it.next().value].innerHTML = '<div class="overlay-left"><img src="images/ovhone.png"></div>Foto<div class="overlay-right"><img src="images/ovhone.png"></div>';
            ...
            toTranslate[it.next().value].innerHTML = '<div class="overlay-left"><img src="images/ovhone.png"></div>Collaborazioni<div class="overlay-right"><img src="images/ovhone.png"></div>';
            toTranslate[it.next().value].innerHTML = '<div class="overlay-left"><img src="images/ovhone.png"></div>Ringraziamenti<div class="overlay-right"><img src="images/ovhone.png"></div>';
            toTranslate[it.next().value].innerHTML = '<a href="https://github.com/Rankoll" target="_blank">Rankoll</a> per la co-programmazione del sito.';
            toTranslate[it.next().value].innerHTML = 'lexA & Xion Romeruf per la revisione testi.';
            toTranslate[it.next().value].innerHTML = '<a href="https://www.instagram.com/michelelosciale/" target="_blank">Losmichele</a> & <a href="https://www.instagram.com/deadman_cosplay/" target="_blank">RaamDeadman</a> per aver acconsentito a pubblicare le collaborazioni.';
            toTranslate[it.next().value].innerHTML = '<a href="https://github.com" target="_blank">GitHub</a> per l\'hosting.';
            toTranslate[it.next().value].innerHTML = 'Un ringraziamento speciale a <a href="https://www.platinumgames.com/" target="_blank">Platinum Games</a> e <a href="https://twitter.com/yokotaro" target="_blank">Yoko Taro</a>.';
