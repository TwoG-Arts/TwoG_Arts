...
function language() {
    ...
    if (check.checked) {
        ...
        if (editing) {
            ...
            toTranslate[it.next().value].innerHTML = 'Darius froma Assassin\'s Creed Odyssey.<sub>PH: RaakDeadman.</sub>';
            ...
            toTranslate[it.next().value].innerHTML = '<div class="overlay-left"><img src="images/ovhone.png"></div>Collaborations<div class="overlay-right"><img src="images/ovhone.png"></div>';            toTranslate[it.next().value].innerHTML = 'Darius from Assassin\'s Creed Odyssey.<sub>PH: RaamDeadman</sub>';
